...
export class Finviz {
     ...
     */
    public static async getStockData(symbol: string, attributes?: FinVizAttribute[]): Promise<FinVizObject> {
        ...
        try {
            ...
            if (attributes?.length) {
                companyData = attributes.reduce((acc: FinVizObject, attr: FinVizAttribute) => {
